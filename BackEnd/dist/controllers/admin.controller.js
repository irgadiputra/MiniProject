...
function CreateCouponController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const coupon = yield (0, admin_service_1.createCouponService)(userId, request);
...
function deleteCouponController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.user;
            const result = yield (0, admin_service_1.deleteCouponService)(userId, req.params.code);
            res.json(result);
        }
        catch (err) {
            next(err);
